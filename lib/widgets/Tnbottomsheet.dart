...
class TNBottomSheetWidget extends StatefulWidget {
  @override
  _TNBottomSheetWidgetState createState() => _TNBottomSheetWidgetState();
}

class _TNBottomSheetWidgetState extends State<TNBottomSheetWidget> {
  int confirm;
  int recovered;
  int deceased;
